...
function AppView(props) {
	return(<div>
		...
		{props.state.database.length === 0 ? <div className="article">
			...
			<h3>示範資料</h3>
			<p>本工具提供<a href="demo1.zip">三國演義</a>和<a href="demo2.zip">韓國電影主要演員資料</a>兩個資料集當作示範資料，下載後並解壓縮，再點選本頁上方的<em>選擇資料集所在的資料夾</em>後開始操作。</p>
			...
			<h3>協助開發此工具</h3>
			<p>本程式<a href="https://github.com/ldkrsi/TaiwanDH-React">在GitHub上開源</a>，歡迎對文字分析工具有興趣的人給我們Pull Request或Fork出延伸版本。</p>
			<br/>
			<p>建議使用chrome來瀏覽以得到最順暢的體驗。</p>
		</div>: ''}
